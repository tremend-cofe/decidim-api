...
module Decidim
  module Api
    ...
    module Types
      autoload :BaseArgument, "decidim/api/base/base_argument"
      autoload :BaseEnum, "decidim/api/base/base_enum"
      autoload :BaseField, "decidim/api/base/base_field"
      autoload :BaseInputObject, "decidim/api/base/base_input_object"
      autoload :BaseInterface, "decidim/api/base/base_interface"
      autoload :BaseMutation, "decidim/api/base/base_mutation"
      autoload :BaseObject, "decidim/api/base/base_object"
      autoload :BaseScalar, "decidim/api/base/base_scalar"
      autoload :BaseUnion, "decidim/api/base/base_union"
    end
  end
